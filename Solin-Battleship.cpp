...
int main() {
	...
	while (true)
	{
		...
		if (what == '1') {
			...
			cout << "Rules. There are 2 fields, your field and the computer field. it has 8 ships of size 1 x 1. The goal of the game is to guess where the computer's ships are and hit them. Good luck!";
			cout << "\n1. Back\nSelect >> ";
			cin >> what;
		}
		else if (what == '3') {
